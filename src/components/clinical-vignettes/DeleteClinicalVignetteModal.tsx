...
interface DeleteClinicalVignetteModalProps {
  isOpen: boolean
...
export function DeleteClinicalVignetteModal({
  isOpen,
  question,
  onClose,
  onConfirm,
}: DeleteClinicalVignetteModalProps) {
  ...
  return (
    ...
    >
      <button
        type="button"
        aria-label="Close delete clinical vignette dialog"
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-clinical-vignette-modal-title"
      ...
      >
        <div className="flex items-start justify-between border-b border-border-subtle bg-surface px-gutter py-5">
          <div className="flex flex-col gap-2 pr-4">
            <h2 id="delete-clinical-vignette-modal-title" className="text-h3 text-on-surface">
        ...
        <div className="px-gutter py-gutter">
          <p className="text-body-md text-on-surface">
            ...
            from previous clinical vignettes?
          </p>
          {error ? (
