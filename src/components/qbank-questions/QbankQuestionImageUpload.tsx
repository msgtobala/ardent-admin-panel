...
interface QbankQuestionImageUploadProps {
  file: File | null
...
export function QbankQuestionImageUpload({
  file,
  previewUrl,
  error,
  disabled = false,
  ...
  return (
    <div className="flex w-full flex-col gap-1">
      <span className="text-label-sm font-semibold text-on-surface">Question Image</span>
      <div
        role="button"
